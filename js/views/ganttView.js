...
const THAI_HOLIDAYS = [
  ...
  '2026-05-01', '2026-05-04', '2026-06-03', '2026-07-28', '2026-07-29', '2026-08-12',
                    ...
                    <div class="gantt-timeline-group-row" style="${group.id === 'events' ? 'position: relative;' : ''}">
                      ${group.id === 'events' ? group.tasks.map(t => {
                        ...
                        return `<div class="gantt-bar ${isCompleted ? 'completed' : ''}" 
                               style="left: ${left}px; width: ${width}px; background: #d97706; color: white; position: absolute; top: 4px; height: 28px; line-height: 28px; padding: 0 8px; z-index: 10; opacity: 0.9; justify-content: center;"
